...
function QueryViewer() {
	...
	this.realShow = function () {
		...
		this.calculateRealOutputType((function () {
			var container = qv.util.dom.getEmptyContainer(this);
			qv.util.dom.createDiv(container, this.userControlId(), "", "", { width: qv.util.fixSize(this.Width) + "px", height: qv.util.fixSize(this.Height) + "px" }, "");
